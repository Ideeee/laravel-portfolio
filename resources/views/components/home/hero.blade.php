      ...
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          <p class="text-base mb-8 max-w-[520px]">
            I am a junior developer with a year of experience building solutions in form of software. <br/>
            I believe that you learn best by teaching others, which is why I created a
            <a
